...
export default function Home() {
  ...
  const [outreachPreselectId, setOutreachPreselectId] = useState<string | null>(
    null,
  );
  ...
  const handleDraftOutreach = (leadId: string) => {
        ...
        <div className="min-h-screen bg-background text-foreground">
          ...
          <main className="lg:ml-64 min-h-screen">
            ...
            <div className="p-6 lg:p-8">
              ...
              {view === 'map' && (
                <LeadsMapClient onDraftOutreach={handleDraftOutreach} />
              )}
            </div>
          </main>
